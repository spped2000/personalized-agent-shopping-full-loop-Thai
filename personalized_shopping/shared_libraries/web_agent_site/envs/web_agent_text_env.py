...
class WebAgentTextEnv(gym.Env):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.action_space = gym.spaces.Text(1000)  # Text actions like "search[keywords]"
        self.observation_space = gym.spaces.Text(10000)  # Text observations (HTML/text content)
